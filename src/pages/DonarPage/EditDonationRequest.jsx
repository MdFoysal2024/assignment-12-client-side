...
const EditDonationRequest = () => {
    ...
    const handleUpdateDonationRequest = event => {
        ...
        axiosPublic.patch(`/updateDonationRequest/${_id}`, formData)

            .then(res => {
                Swal.fire({
                    title: 'Update Donation Request',
                    text: 'Donation Request Update Successfully',
                    icon: 'success',
                    ...
                    <form
                        ...
                        <div className="flex flex-col md:flex-row justify-between gap-6">
                            ...
                            <label className="form-control w-full mb-6">
                                ...
                                <select defaultValue={blood_group} name="blood_group"
                        ...
                        <div className="form-control w-full">
                            ...
                            <textarea name="request_message" defaultValue={request_message} id="" className="input input-bordered" required ></textarea>
                        </div>


                        <div className="form-control mt-6">
                            <button className="btn bg-red-600 text-white text-lg hover:bg-red-800 w-64 mx-auto">Update Request</button>
                        </div>
                    </form>
                </div>
            </div>
